...
const MainPrayerBottomModal = () => {
  ...
  const modifyHandler = () => {
    setActiveOverlays(["PRAYER_MODIFY_MODAL"]);
  };
  ...
  const completeHandler = () => {
    completePray(selectedPray.prayId);
    showToast({
      message: "기도제목을 완료했어요.",
      theme: ToastTheme.SUCCESS,
    });
    setSelectedPrayToEdit(null);
  };
  ...
  return (
    <>
      <S.BlackBackground onClick={closeHandler} showModal={showModal} />
      <S.BottomSetWrapper selectedPrayInfo={selectedPray}>
        <S.BottomButtonWrapper>
          <img src={completeImage} alt="" />
          <S.BottomButtonText color={"green"} onClick={completeHandler}>
            완료하기
          </S.BottomButtonText>
        </S.BottomButtonWrapper>
        <S.BottomButtonWrapper>
          <img src={modifyImage} alt="" />
          <S.BottomButtonText color={"blue"} onClick={modifyHandler}>
            수정하기
          </S.BottomButtonText>
        </S.BottomButtonWrapper>
        <S.BottomButtonWrapper>
          <img src={deleteImage} alt="" />
          <S.BottomButtonText color={"red"} onClick={deleteHandler}>
            삭제하기
          </S.BottomButtonText>
        </S.BottomButtonWrapper>
      </S.BottomSetWrapper>
...
export default MainPrayerBottomModal;
...
const S = {
  ...
  BottomSetWrapper: styled.div`
    ...
    bottom: ${(props) =>
      props.selectedPray === null || props.showModal ? "-100%" : "0px"};
    z-index: 202;
  ...
  BlackBackground: styled.div`
    ...
    bottom: 0;
    z-index: ${(props) =>
      props.selectedPray !== null ? 100 : props.shareMode ? 198 : 0};
    opacity: ${(props) =>
      props.selectedPray !== null || props.shareMode ? 1 : 0};
