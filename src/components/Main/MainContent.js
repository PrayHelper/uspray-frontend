...
const MainContent = ({ categories, setCategories, setShowCategorySetting }) => {
  ...
  return (
    <MainContentWrapper>
      ...
      <Content>
        <Category title="테스트" color="#75BD62" setSelectedTitleIndex={setSelectedTitleIndex} />
        <Category title="테스트2" color="#AEDBA5" setSelectedTitleIndex={setSelectedTitleIndex} />
      </Content>
      <BottomSetWrapper selectedTitleIndex={selectedTitleIndex}>
        <BottomButtonWrapper>
          <img src={completeImage} />
          <BottomButtonText color={"green"} onClick={() => prayComplete()}>완료하기</BottomButtonText>
        </BottomButtonWrapper>
        <BottomButtonWrapper>
          <img src={modifyImage} />
          <BottomButtonText color={"blue"} onClick={() => prayModify()}>수정하기</BottomButtonText>
        </BottomButtonWrapper>
        <BottomButtonWrapper>
          <img src={deleteImage} />
          <BottomButtonText color={"red"} onClick={() => prayDeleted()}>삭제하기</BottomButtonText>
        </BottomButtonWrapper>
      </BottomSetWrapper>
      <BlackBackground selectedTitleIndex={selectedTitleIndex} onClick={() => setSelectedTitleIndex(null)} />
    </MainContentWrapper>
  );
};
...
const BottomButtonText = styled.div`
  ...
  font-weight: 700;
  line-height: normal;
  color : ${(props) => props.color == "green" ? "#27CD2F" : (props.color == "blue") ? "#408CFF" : "#FF4F4F"};
`
...
const BlackBackground = styled.div`
  ...
  pointer-events : ${(props) => props.selectedTitleIndex !== null ? "auto" : "none"};
`
